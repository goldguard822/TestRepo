...
document.writeln('  <span role="slide_close" style="float:left; display:inline-block; width:100%; height:30px; background: rgba(0,0,0,0.4) url(//up.implay.co.kr/images/btnO_arrow_down.gif) no-repeat center center; background-size: 20px 20px;"></span>');
