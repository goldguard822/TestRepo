...
document.writeln('  <span role="banner_area" class="banner_area_bottom" style="float:left; display:inline-block; width:100%; height:30px; background: rgba(0,0,0,0.4) url(//up.implay.co.kr/images/btnO_arrow_up.gif) no-repeat center center; background-size: 20px 20px; touch-action:none;"></span>');
