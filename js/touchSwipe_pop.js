...
document.writeln('<link type="text/css" href="./css/touchSwipe_pop.css" rel="stylesheet" />'); // 터치 스와이프 CSS 경로 확인 필수
...
document.writeln('  <span role="slide_close" style="color:bloack; font-size:20px; text-align:center; line-height:40px;">X</span>');
