...
document.writeln('  <span role="slide_close" style="position: absolute; top: 0px; right: 0px; width: 40px; height: 40px; background: rgba(0,0,0,0.5) url(images/btn_popClose.png) center center no-repeat; background-size: 30px 30px;"></span>');
